...
public class OldExhibitCollectionRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<Integer> listImageExhibit;
    public OldExhibitCollectionRecyclerViewAdapter(Context context, List<Integer> listImageExhibit)
    {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        viewHolder = new OldExhibitCollectionRecyclerViewAdapter.DataItem(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        OldExhibitCollectionRecyclerViewAdapter.DataItem mHolder = (OldExhibitCollectionRecyclerViewAdapter.DataItem) holder;
