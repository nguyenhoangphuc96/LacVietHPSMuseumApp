...
public class OldSearchResultRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<ExhibitModels> listExhibit;

    public OldSearchResultRecyclerViewAdapter(Context context, List<ExhibitModels> listExhibit) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder = new OldSearchResultRecyclerViewAdapter.DataItem(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        OldSearchResultRecyclerViewAdapter.DataItem mHolder = (OldSearchResultRecyclerViewAdapter.DataItem) holder;
