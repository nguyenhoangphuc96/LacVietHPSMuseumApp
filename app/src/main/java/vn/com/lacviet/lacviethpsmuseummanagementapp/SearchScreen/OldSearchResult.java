...
import vn.com.lacviet.lacviethpsmuseummanagementapp.adapter.OldSearchResultRecyclerViewAdapter;
import vn.com.lacviet.lacviethpsmuseummanagementapp.model.ExhibitModels;

public class OldSearchResult extends AppCompatActivity {
    private RecyclerView recyclerView;
    private OldSearchResultRecyclerViewAdapter adapterSearchResult;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapterSearchResult = new OldSearchResultRecyclerViewAdapter(this,listExhibit);
